  ...
  return (
    <div id="content" className="content-area">
      <Spin spinning={loading}>
                  ...
                  >
                    {mediaList.map((src, index) => (
                      <SwiperSlide key={index}>
                        <Image
                          src={src}
                          alt={`${product?.prodName || "Product"} ${index + 1}`}
              ...
              <div className="_5enz">
                <div className="product-info">
                  ...
                  {product?.specification && (
                    <div className="contents widget-content product-information">
                      <h4 className="_9cfu">Product Information:</h4>
                      <div
                        className="inner-content product-info-spec-wrap"
                        dangerouslySetInnerHTML={{
        ...
        {/* Specifications section moved inline under Product Information (see Figma).
            Original separate section preserved below in legacy block. */}
                    ...
                    <div className="_8sxd">
                      <Row gutter={20}>
                        <Col span={24} className="_0lfn">
                          <Swiper
                            onSwiper={(swiper) => {
                              swiperRef.current = swiper; // Gß║»n instance cß╗ºa Swiper v├áo ref
                            }}
                            modules={[Autoplay]}
                            spaceBetween={0}
                            slidesPerView={1}
